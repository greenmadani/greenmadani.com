...
export default function ProductDetail() {
 ...
 if (isLoading) {
 return (
 <div className="container mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-6 md:gap-16">
 <Skeleton className="w-full aspect-square bg-muted" />
 <div>
 <Skeleton className="w-24 h-6 mb-6" />
 <Skeleton className="w-full h-12 mb-6" />
 <Skeleton className="w-full h-32 mb-4 md:mb-8" />
 ...
 <Link href="/products" className="inline-flex items-center text-primary font-semibold hover:text-accent mb-4 md:mb-8 transition-colors">
 ...
 <div className="prose prose-lg prose-green mb-4 md:mb-10 text-muted-foreground">
