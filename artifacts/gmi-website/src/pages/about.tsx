...
export default function About() {
 ...
 <div className="w-12 h-12 bg-white flex items-center justify-center mx-auto mb-3 shadow-sm">
 ...
 {/* Founder's Message */}
 <AnimatedSection animation="fade-in">
 <section className="py-16 md:py-24 bg-secondary text-white border-y-4 border-accent overflow-hidden relative">
 <AnimatedBackground />
 <div className="container mx-auto px-4 relative z-10">
 <div className="text-center mb-8 md:mb-16">
 <SectionHeader badge="Leadership" title="Founder's Message" className="[&_h2]:text-white" />
 </div>
 <div className="max-w-5xl mx-auto grid md:grid-cols-5 gap-6 md:gap-12 items-center">
 <div className="md:col-span-2 flex justify-center">
 <div className="w-full max-w-sm shimmer-wrap img-hover shadow-xl border border-white/10 border-b-4 border-b-accent/30">
 ...
 <div className="relative border-l-4 border-primary/20 pl-8 ml-4 md:ml-0 md:pl-0 md:border-l-0 space-y-6 md:space-y-12">
 ...
 <div className="absolute left-[-42px] md:left-1/2 md:-translate-x-1/2 w-8 h-8 bg-primary border-4 border-white flex items-center justify-center z-10 shadow-sm">
