...
export default function Home() {
 ...
 <p>
 Green Madani International Private Ltd. is a diversified business group operating across 12 integrated verticals — from agriculture and food to healthcare, education, hospitality, and media. Founded and led by Md. Rejaul Karim Mojumder, GMI was built on a single belief: that sustainable, technology-driven business can transform communities while delivering lasting value.
 </p>
 <p>
