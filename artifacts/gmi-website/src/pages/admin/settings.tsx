...
export default function AdminSettings() {
 ...
 <input type="color" value={form.announcementBgColor} onChange={(e) => set("announcementBgColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
 ...
 <div className="flex gap-2 mt-1">
 <input type="color" value={form.announcementTextColor} onChange={(e) => set("announcementTextColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
 ...
 <div key={i} className="flex items-center gap-2 bg-muted p-2">
 ...
 <div className="flex gap-2 mt-1">
 <input type="color" value={form.primaryColor} onChange={(e) => set("primaryColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
 ...
 <div className="flex gap-2 mt-1">
 <input type="color" value={form.accentColor} onChange={(e) => set("accentColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
 ...
 <div className="flex gap-2 mt-1">
 <input type="color" value={form.footerBgColor} onChange={(e) => set("footerBgColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
 ...
 <div className="flex gap-2 mt-1">
 <input type="color" value={form.bgColor} onChange={(e) => set("bgColor", e.target.value)} className="h-10 w-10 border cursor-pointer" />
...
function ImageField({ label, value, onChange, browseField, browseOpen, onBrowseOpen }:{
 ...
 <img src={value} alt={label} className="h-14 w-14 object-cover border" />
