  ...
  if (!business) {
    return (
      <div className="w-full py-40 text-center">
        <h2 className="text-3xl font-display font-bold text-foreground mb-4">Business Not Found</h2>
    ...
    <div className="w-full pb-24 bg-white">
      ...
      <section className="bg-primary text-white pt-[64px] pb-24 -mt-20 relative border-b-4 border-accent overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center text-sm font-display font-semibold tracking-wider uppercase text-white/60 mb-6 flex-wrap gap-y-2">
        ...
        <div className="grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-12">
            ...
            {business.services && business.services.length > 0 && (
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-6">Key Offerings & Services</h2>
            ...
            {business.targetAudience && (
              <div>
                <h2 className="text-3xl font-display font-bold text-foreground mb-6">Target Market</h2>
          ...
          <div>
            <div className="bg-background p-8 border border-border shadow-sm sticky top-32">
              <h3 className="text-2xl font-display font-bold text-foreground mb-4">Partner with Us</h3>
