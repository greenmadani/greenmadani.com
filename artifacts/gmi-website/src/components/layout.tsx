    ...
    <div className="min-h-screen flex flex-col bg-[#F9F7F2]">
      ...
      <div className="bg-[#1A5C38] text-white text-xs py-1.5 px-4 flex justify-between items-center z-50 relative">
        <div className="container mx-auto flex justify-between items-center">
          <span className="font-medium tracking-wide uppercase opacity-90">Welcome to Green Madani International Private Ltd.</span>
          <div className="flex items-center gap-4">
            <a href="#" className="hover:text-[#C8960C] transition-colors"><Facebook size={12} /></a>
            <a href="#" className="hover:text-[#C8960C] transition-colors"><Twitter size={12} /></a>
            <a href="#" className="hover:text-[#C8960C] transition-colors"><Youtube size={12} /></a>
            <a href="#" className="hover:text-[#C8960C] transition-colors"><Linkedin size={12} /></a>
          </div>
        </div>
      </div>
      ...
      <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-border shadow-sm">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <Link href="/">
            <span className="text-3xl font-display font-extrabold text-[#C8960C] tracking-tighter cursor-pointer">GMI</span>
          </Link>
      ...
      <footer className="bg-[#0D3D25] text-white pt-16 pb-8 islamic-pattern-overlay relative border-t-4 border-[#C8960C]">
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <h2 className="text-4xl font-display font-extrabold text-[#C8960C] mb-6">GMI</h2>
              <p className="text-white/80 text-sm leading-relaxed mb-6">
                A diversified business group driving sustainable growth across Bangladesh and beyond. Rooted in heritage, looking to the future.
              </p>
              <div className="flex items-center gap-4">
                <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#C8960C] transition-colors"><Facebook size={14} /></a>
                <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#C8960C] transition-colors"><Twitter size={14} /></a>
                <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#C8960C] transition-colors"><Youtube size={14} /></a>
                <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#C8960C] transition-colors"><Linkedin size={14} /></a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-white/80">
                <li className="flex items-start gap-3">
                  ...
                  <span>924/C, Taltola Moor, Khilgaon-1219, Dhaka</span>
                </li>
                <li className="flex items-center gap-3">
                  <Phone size={18} className="text-[#C8960C] shrink-0" />
                  <span>01340-862454</span>
                </li>
                <li className="flex items-center gap-3">
                  <Mail size={18} className="text-[#C8960C] shrink-0" />
                  <span>info@greenmadani.com</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/60">
            <p>© 2026 Green Madani International Private Ltd. All rights reserved.</p>
