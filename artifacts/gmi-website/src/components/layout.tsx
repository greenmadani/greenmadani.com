...
export function Layout({ children }:{ children:ReactNode }) {
 ...
 {s?.footerLogoUrl ? (
 <img src={s.footerLogoUrl} alt={s.siteName || "GMI"} className="h-12 w-auto mb-4 md:mb-6" />
 ) :(
 ...
 {footerCols.map((col) => (
 <div key={col.title}>
 <h3 className="mb-4 md:mb-6 font-display text-white">{col.title}</h3>
 ...
 <span className="hover:text-white cursor-pointer transition-colors link-underline">{link.label}</span>
          ...
          <div className="col-span-2 md:col-span-2 lg:col-span-1">
            <h3 className="mb-4 md:mb-6 font-display text-white">Contact Info</h3>
