...
export function CTASection() {
 ...
 <div className="bg-card p-6 md:p-12 border-t-4 border-primary shadow-sm flex flex-col justify-between">
 <div>
 ...
 <p className="text-muted-foreground mb-4 md:mb-8 text-lg">
 ...
 <div className="bg-card p-6 md:p-12 border-t-4 border-accent shadow-sm flex flex-col justify-between">
 <div>
